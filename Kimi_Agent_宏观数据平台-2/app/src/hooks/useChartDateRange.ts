...
export function useChartDateRange(defaultStartYear = 2025, defaultStartMonth = 4, defaultEndYear = 2026, defaultEndMonth = 3) {
  ...
  const presets = [
    { label: '近1年', sy: 2025, sm: 4, ey: 2026, em: 3 },
    { label: '近3年', sy: 2023, sm: 4, ey: 2026, em: 3 },
    { label: '近5年', sy: 2021, sm: 4, ey: 2026, em: 3 },
    { label: '近10年', sy: 2016, sm: 4, ey: 2026, em: 3 },
    { label: '全部', sy: 2010, sm: 1, ey: 2026, em: 3 },
  ];
